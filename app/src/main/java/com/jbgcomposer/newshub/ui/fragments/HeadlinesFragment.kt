...
import com.jbgcomposer.newshub.databinding.FragmentHeadlinesBinding
...
class HeadlinesFragment : Fragment() {
    ...
    private val headlinesAdapter by lazy {
        NewsAdapter { article ->
    ...
    private fun submitDataAdapter() {
        lifecycleScope.launch {
            viewModel.headlinesPagingDataFlow.collectLatest(headlinesAdapter::submitData)
        }
    }

    private fun setupProgressBar() {
        headlinesAdapter.addLoadStateListener { loadState ->
